            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" enctype="multipart/form-data">
                   ...
                   <!--  <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="img" type="text" name="img" value="<?php echo $result->img; ?>" />
                        </div>
                    </div> -->

                    <!-- Adicione no formulário de editarProduto -->
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <?php if (!empty($result->img)) : ?>
            <img src="<?php echo base_url($result->img); ?>" alt="Imagem Atual" style="max-width: 200px; max-height: 200px;">
            <br>
            <label for="removerImagem" class="checkbox">
                <input type="checkbox" name="removerImagem" value="1"> Remover Imagem
            </label>
        <?php else : ?>
