            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="especificacao" type="text" name="especificacao" value="<?php echo set_value('especificacao'); ?>" />
                        </div>
                    </div>

                    <!-- UPLOAD NOME DA IMAGEM
                        
                    <div class="control-group">
                        <label for="img" class="control-label">Imagem</label>
                        <div class="controls">
                            <input id="img" type="text" name="img" value="<?php echo set_value('img'); ?>" />
                        </div>
                    </div> -->
