    ...
    <div id="modalCadastrar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form action="<?= site_url('mapos/cadastrarEmitente'); ?>" id="formCadastrar" enctype="multipart/form-data" method="post" class="form-horizontal">
            ...
            <div class="modal-body" style="display: grid;grid-template-columns: 1fr 1fr">
                ...
                <div class="control-group">
                    <label for="whatsapp" class="control-label"></span></label>
                    <div class="controls">
                        <input id="whatsapp" type="text" placeholder="seu whatsapp" name="whatsapp" value="" />
                    </div>
                </div>

                <div class="control-group">
                    <label for="instagram" class="control-label"></span></label>
                    <div class="controls">
                        <input id="instagram" type="text" placeholder="Seu instagram" name="instagram" value="" />
                    </div>
                </div>
                <div class="control-group">
                    <label for="facebook" class="control-label"></span></label>
                    <div class="controls">
                        <input id="facebook" type="text" placeholder="facebook" name="facebook" value="" />
                    </div>
                </div>
        ...
        <form action="<?= site_url('mapos/editarEmitente'); ?>" id="formAlterar" enctype="multipart/form-data" method="post" class="form-horizontal">
            ...
            <div class="modal-body" style="display: grid;grid-template-columns: 1fr 1fr">
                ...
                <div class="control-group">
                    <label for="whatsapp" class="control-label"></span></label>
                    <div class="controls">
                        <input id="whatsapp" type="text" placeholder="seu whatsapp" name="whatsapp" value="<?= $dados->whatsapp; ?>" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    <label for="instagram" class="control-label"></span></label>
                    <div class="controls">
                        <input id="instagram" type="text" placeholder="Seu instagram" name="instagram" value="<?= $dados->instagram; ?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label for="facebook" class="control-label"></span></label>
                    <div class="controls">
                        <input id="facebook" type="text" placeholder="facebook" name="facebook" value="<?= $dados->facebook; ?>" />
                    </div>
                </div>
