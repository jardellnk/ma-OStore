<?php
// Verificar se está sendo passado na URL a página atual, senão atribuir a página 1
                        ...
                        <div class="col-sm-4">
                            <div class="card mt-4">
                                <div class="thumbnail">
                                    ...
                                    $img_src = (!empty($row_produtos['img']) && file_exists($img_path)) ? $img_path : 'os/assets/produtos/default.jpg';
                                    echo '<img src="' . $img_src . '" alt="..." height="200" width="200">';
                                    ?>
                                    <p>
                                        <div class="card-body">
                                            <a href="detalhes.php?id_produtos=<?php echo $row_produtos['idProdutos']; ?>">
                                                <?php echo $row_produtos['descricao']; ?><br>
                                                <!-- Adicionar informação de preço -->
                                                <?php echo 'A partir de R$ '  . number_format($row_produtos['precoVenda'], 2, ',', '.'); ?>
                                                <br><br>
                                            </a>
