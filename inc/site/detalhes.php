<?php 
// Certifique-se de ter a conexão $conn estabelecida previamente
...
$resultado_emitente = mysqli_query($conn, $query_emitente);
$row_emitente = mysqli_fetch_assoc($resultado_emitente);
?>
...
<div class="container">
    <div class="row">
        <div class="col-lg-4">
            <div class="card mt-4">
                <?php
                $img_path = $dir_img . $row_produtos['img'];
                $image_source = (empty($row_produtos['img']) || !file_exists($img_path)) ? 'assets/produtos/default.jpg' : $img_path;
                ?>
        ...
        <div class="col-lg-8">
            <div class="card card-outline-secondary my-4">
                ...
                <div class="card-body">
                  <pre>  <p class="card-text"><?php echo $row_produtos['especificacao']; ?></p></pre>
                    <hr>
                    <br>
